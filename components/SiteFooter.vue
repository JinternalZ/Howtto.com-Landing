<template>
  <footer class="border-t py-6 md:px-8 md:py-0">
    <div class="container grid grid-cols-1 gap-6 py-14 sm:grid-cols-2 md:grid-cols-5">
      <div class="col-span-5 xl:col-span-2 flex justify-center md:justify-start items-start flex-col space-y-2">
        ...
        <p class="md:max-w-[75%] leading-normal text-muted-foreground">
          {{ siteDescription }}
        </p>
      </div>
      <div
